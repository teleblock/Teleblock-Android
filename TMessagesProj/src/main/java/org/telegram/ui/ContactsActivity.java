...
public class ContactsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    //自定义START
    public ActionBarMenuItem.ActionBarMenuItemSearchListener searchListener;
    ...
    public View createView(Context context) {
        ...
        ActionBarMenuItem item = menu.addItem(search_button, R.drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(searchListener = new ActionBarMenuItem.ActionBarMenuItemSearchListener() {
            @Override
