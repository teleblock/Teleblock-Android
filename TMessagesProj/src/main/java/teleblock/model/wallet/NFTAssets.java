...
public class NFTAssets {
    ...
    public static NFTInfoList parse(NFTAssets nftAssets) {
        NFTInfoList nftInfoList = new NFTInfoList();
        List<NFTInfo> nftInfos = new ArrayList<>();
        for (AssetsEntity assetsEntity : nftAssets.assets) {
            nftInfos.add(AssetsEntity.parse(assetsEntity));
        }
    ...
    public static class AssetsEntity {
        ...
        public static NFTInfo parse(AssetsEntity assetsEntity) {
