    ...
    public static void startPushService() {
        ...
        if (enabled) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                pintent = PendingIntent.getBroadcast(applicationContext, 0, intent,
                        PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE);
            } else {
                pintent = PendingIntent.getBroadcast(applicationContext, 0, intent, PendingIntent.FLAG_UPDATE_CURRENT);
            }
