...
public class ChannelMessagesLoader2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    private void loadMore() {
        ...
        getMessagesController().loadMessages(-chat.id,0,false,requestCount,maxMessageId[0],0,!cacheEndReached[0], minDate[0],classGuid,0,0,0,0,replyMaxReadId,lastLoadIndex++);
    }
