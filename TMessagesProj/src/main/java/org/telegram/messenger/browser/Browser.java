        ...
        try {
            ...
            if (allowCustom && SharedConfig.customTabs && !internalUri && !scheme.equals("tel")) {
                ...
                if (forceBrowser[0] || allActivities == null || allActivities.isEmpty()) {
                    ...
                    PendingIntent copy = PendingIntent.getBroadcast(ApplicationLoader.applicationContext, 0, new Intent(ApplicationLoader.applicationContext, CustomTabsCopyReceiver.class), Build.VERSION.SDK_INT >= Build.VERSION_CODES.M ? PendingIntent.FLAG_IMMUTABLE :PendingIntent.FLAG_UPDATE_CURRENT);
