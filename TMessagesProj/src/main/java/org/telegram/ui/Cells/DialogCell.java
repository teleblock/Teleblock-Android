...
public class DialogCell extends BaseCell {
    ...
    public void setDialog(TLRPC.Dialog dialog, int type, int folder, boolean canPin, boolean forcePin) {
        setDialog(dialog, type, folder);
        this.canPin = canPin;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!canPin) drawPin = drawPinBackground = false;
