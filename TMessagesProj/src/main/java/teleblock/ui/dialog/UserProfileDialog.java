...
public class UserProfileDialog extends BaseBottomSheetDialog implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void show() {
        ...
        getWindow().getDecorView().setBackground(getContext().getResources().getDrawable(R.drawable.bg_dialog_user_profile));
    }
    ...
    public void didReceivedNotification(int id, int account, Object... args) {
        if (id == NotificationCenter.userInfoDidLoad) {
            ...
            MessageObject messageObject = fragment.getMediaDataController().getFoundMessageObjects().get((Integer) args[4]);
